...
export const MILESTONES: Milestone[] = [
  ...
  // ───────────────────────── Craft (truly advanced) ─────────────────────────
  {
    ...
    requiredLessonSlugs: ['rs-craft-chord-tones'],
  },
  {
    id: 'read-notation',
    stage: 'craft',
    ...
    requiredLessonSlugs: ['rs-craft-read-notation'],
  },
  {
    id: 'hybrid-picking',
    stage: 'craft',
    ...
    requiredLessonSlugs: ['rs-craft-hybrid-picking'],
  },
  {
    id: 'reharmonize',
    stage: 'craft',
    ...
    requiredLessonSlugs: ['rs-craft-reharmonize'],
  },
  {
    ...
    requiredLessonSlugs: ['rs-craft-compose-piece'],
  },
  {
    id: 'recorded-track',
    stage: 'craft',
    ...
    requiredLessonSlugs: ['rs-craft-record-track'],
  },
  {
    id: 'gigged',
    stage: 'craft',
    ...
    requiredLessonSlugs: ['rs-craft-gig-prep'],
  },
  {
    id: 'taught-someone',
    stage: 'craft',
    ...
    requiredLessonSlugs: ['rs-craft-teach-others'],
  },
]
